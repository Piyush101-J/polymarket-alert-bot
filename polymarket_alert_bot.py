...
def extract_probabilities(outcomes):
    """Extract probabilities - try multiple formats"""
...
def bot_loop():
    print("=== STARTING BOT LOOP (DEBUG MODE) ===")
    try:
        ...
        for m in markets:
            ...
            # DEBUG: Print full JSON of first 5 Bitcoin markets
            if debug_count < 5:
                print("\n" + "="*80)
                print("DEBUG BITCOIN MARKET #" + str(debug_count + 1))
                print("="*80)
            ...
            if not has_direction:
                print(">>> Bitcoin market (no direction): " + question[:60])
                continue
...
def run_bot():
    print("=== BOT v7 - FULL DEBUG MODE ===")
    
    startup_msg = "🔍 Bot v7 DEBUG is LIVE!\n\n"
    startup_msg += "This run will show FULL JSON of Bitcoin markets\n"
    startup_msg += "Check Railway logs to see market structure!\n\n"
    startup_msg += "Will run once then you can analyze logs."
    ...
    print("Check the logs above to see the JSON structure of Bitcoin markets")
    print("="*80)
...
1. ✅ **Print FULL JSON** of the first 5 Bitcoin markets
2. ✅ Show us the EXACT structure
3. ✅ We'll see:
   - How probabilities are stored
...
```
DEBUG BITCOIN MARKET #1
========================
Question: Bitcoin above 70000 on February 8
Event: Bitcoin above ___ on February 8?
