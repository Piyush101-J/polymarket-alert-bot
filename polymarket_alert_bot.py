...
def extract_probabilities(market):
    """Extract probabilities - handles string-encoded format from API"""
    
    # Try format 1: Structured outcomes array
    ...
    # Try format 2: String-encoded outcomes (THE FIX!)
    ...
    if outcomes_str and prices_str:
        try:
            ...
            # If we have 2 prices, assume first is YES
...
def run_bot():
    print("=== BOT v8 FINAL - PROBABILITY FIX ===")
    
    startup_msg = "Bot v8 FINAL is LIVE!\n\nFixed probability parsing\nShould now find Bitcoin markets with prices!"
