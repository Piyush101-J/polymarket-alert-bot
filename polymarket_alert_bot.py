...
MIN_YES_PROB = 0.01
MAX_YES_PROB = 0.40
YES_PRICE_BUFFER_LOW = 600
YES_PRICE_BUFFER_HIGH = 700
...
def run_bot():
    print("=== WORKER BOOTED - SMART MODE v2 ===")
    
    startup_msg = "🚀 Polymarket SMART BOT v2 is LIVE!\n\n"
    ...
    startup_msg += "🔒 Secure: Credentials from environment variables"
